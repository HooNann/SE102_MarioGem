...
void Render() {
  ...
  pD3DDevice->OMSetBlendState(g->GetAlphaBlending(), NewBlendFactor,
                              0xffffffff);
...
HWND CreateGameWindow(HINSTANCE hInstance, int nCmdShow, int ScreenWidth,
                      int ScreenHeight) {
  WNDCLASSEX wc;
  ...
  wc.cbClsExtra = 0;
  wc.cbWndExtra = 0;
  wc.hIcon = (HICON)LoadImage(hInstance, WINDOW_ICON_PATH, IMAGE_ICON, 0, 0,
                              LR_LOADFROMFILE);
  ...
  HWND hWnd = CreateWindow(
      ...
      CW_USEDEFAULT, CW_USEDEFAULT, ScreenWidth, ScreenHeight, NULL, NULL,
      hInstance, NULL);
...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance,
  ...
  HWND hWnd =
      CreateGameWindow(hInstance, nCmdShow, SCREEN_WIDTH, SCREEN_HEIGHT);
